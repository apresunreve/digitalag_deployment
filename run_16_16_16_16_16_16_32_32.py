...
res00 = '<a>Model 16_16_16_16_16_16_32_32</a><br>'
res0 = '<a>Execution time summary:</a><br>'
res1 = '<a> mean(ms): 1.1874</a><br>'
res2 = '<a> median(ms): 1.1916</a><br>'
res3 = '<a> max(ms): 1.1974</a><br>'
res4 = '<a> min(ms): 1.1732</a><br>'
res5 = '<a> std(ms): 0.0103</a><br>'
res6 = '<a>Accuracy on test set: 89.6%</a><br>'
#1.1874       1.1916       1.1974       1.1732       0.0103
#
html0 = '''
<html>
<head>
